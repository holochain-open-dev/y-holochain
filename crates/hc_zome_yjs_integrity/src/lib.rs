...
pub fn validate(op: Op) -> ExternResult<ValidateCallbackResult> {
    match op.flattened::<EntryTypes, LinkTypes>()? {
        ...
        FlatOp::RegisterCreateLink {
            ...
            match link_type {
                LinkTypes::DocumentUpdates => {
                    validate_create_link_document_updates(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::AllDocuments => {
                    validate_create_link_all_documents(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::DocumentToStatevectors => {
                    validate_create_link_document_to_statevectors(
                        action,
                        base_address,
                        target_address,
                        tag,
        ...
        FlatOp::RegisterDeleteLink {
            ...
            match link_type {
                LinkTypes::DocumentUpdates => {
                    validate_delete_link_document_updates(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::AllDocuments => {
                    validate_delete_link_all_documents(
                        action,
                        original_action,
                        base_address,
                        target_address,
